...
final class UpnpTests: XCTestCase {
    func testAddPortMapping() {
        ...
        _ = Upnp.addPortMapping(
            for: Int.random(in: validPortRange),
            programName: "UpnpTests"
        ).then {
    ...
    func testAddPortMappingUnauthorized() {
        ...
        _ = Upnp.addPortMapping(for: 123, programName: "UpnpTests").catch {
    ...
    func testSearchGateway() {
        ...
        _ = DeviceFinder.searchGateway(friendlyName: "UpnpTests").then { _ in
            expectation.fulfill()
        }
    ...
    func testEndpointForService() {
        ...
        _ = Upnp.endpoint(forService: .wanIPConnection(1)).then { _ in 
            expectation.fulfill()
        }
